...
!(function (e, t) {
                    ...
                    if (((d = [s ? m.firstChild : m.lastChild]), s && v)) {
                      for (
                        b =
                          (f =
                            (c =
                              (u =
                                (p = (h = m)[x] || (h[x] = {}))[h.uniqueID] ||
                                (p[h.uniqueID] = {}))[e] || [])[0] === _ &&
                            c[1]) && c[2],
                          h = f && m.childNodes[f];
                        (h = (++f && h && h[g]) || (b = f = 0) || d.pop());
                      ...
                      (v &&
                        (b = f =
                          (c =
                            (u =
                              (p = (h = t)[x] || (h[x] = {}))[h.uniqueID] ||
                              (p[h.uniqueID] = {}))[e] || [])[0] === _ && c[1]),
                      !1 === b)
                    )
                      for (
                        ;
      ...
      return (
        ...
        ce(function (r, s, a, l) {
          var c,
            ...
            y = n ? (o || (r ? e : d || i) ? [] : s) : m;
          if ((n && n(m, y, a, l), i))
            for (c = _e(y, f), i(c, [], a, l), u = c.length; u--; )
              (p = c[u]) && (y[f[u]] = !(m[f[u]] = p));
          if (r) {
            if (o || e) {
              if (o) {
            ...
            (m = S(
              ...
              (u = function (e, t, n, s, u) {
                ...
                for (
                  ...
                  if (l && p) {
                    for (
                      d = 0, t || p.ownerDocument == f || (h(p), (n = !g));
                      (m = o[d++]);
                ...
                if (((y += v), a && v !== y)) {
                  ...
                  if (e) {
                    if (0 < y) for (; v--; ) b[v] || x[v] || (x[v] = M.call(s));
                    x = _e(x);
                  }
                  N.apply(s, x),
                    u &&
  ...
  (w.filter = function (e, t, n) {
    ...
    w.fn.extend({
      ...
      is: function (e) {
        return !!O(this, "string" == typeof e && S.test(e) ? w(e) : e || [], !1)
          .length;
      },
    });
  var L,
      ...
      function (e, t) {
        w.fn[e] = function (n, i) {
          ...
          return (
            ...
            1 < this.length &&
              (N[e] || w.uniqueSort(o), j.test(e) && o.reverse()),
            this.pushStack(o)
          );
        };
      }
  ...
  function be(e, t, n, i, o) {
    ...
    for (p.textContent = "", f = 0; (r = h[f++]); )
      if (i && -1 < w.inArray(r, i)) o && o.push(r);
        ...
        ((c = oe(r)), (s = me(p.appendChild(r), "script")), c && ye(s), n)
      )
          ...
          (f = g = (a = xe.exec(t[c]) || [])[1]),
            ...
            f &&
              ...
              (h = l[f]) ||
                ...
                (p.setup && !1 !== p.setup.call(e, i, d, s)) ||
                  (e.addEventListener && e.addEventListener(f, s))),
              p.add &&
                (p.add.call(e, u), u.handler.guid || (u.handler.guid = n.guid)),
      ...
      if (m && (l = m.events)) {
        for (c = (t = (t || "").match(P) || [""]).length; c--; )
          if (
            ...
            s &&
              !h.length &&
              ((p.teardown && !1 !== p.teardown.call(e, d, m.handle)) ||
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          var t = this || e;
          return (
            he.test(t.type) && t.click && C(t, "input") && Te(t, "click", we),
            !1
          );
        },
        trigger: function (e) {
          var t = this || e;
          return (
            he.test(t.type) && t.click && C(t, "input") && Te(t, "click"), !0
          );
        },
        _default: function (e) {
          var t = e.target;
          ...
          (c = a[p]),
            de.test(c.type || "") &&
              ...
              (c.src && "module" !== (c.type || "").toLowerCase()
                ...
                : v(c.textContent.replace(Ae, ""), c, u));
    }
    return e;
  }
  function De(e, t, n) {
    for (var i, o = t ? w.filter(t, e) : e, r = 0; null != (i = o[r]); r++)
      n || 1 !== i.nodeType || w.cleanData(me(i)),
        i.parentNode &&
          (n && oe(i) && ye(me(i, "script")), i.parentNode.removeChild(i));
    return e;
  }
  w.extend({
    ...
    clone: function (e, t, n) {
      ...
      return (
        0 < (s = me(u, "script")).length && ye(s, !p && me(e, "script")), u
      );
    },
    ...
    style: function (e, t, n, i) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var o,
          ...
          c = e.style;
        if (
          (l || (t = Ue(a)), (s = w.cssHooks[t] || w.cssHooks[a]), void 0 === n)
        )
        ...
        if ((l = !w.isEmptyObject(t)) || !w.isEmptyObject(f))
          ...
          f))
            l ||
              ...
              g && ce([e], !0),
              h.done(function () {
                for (i in (g || ce([e]), K.remove(e, "fxshow"), f))
                  w.style(e, i, f[i]);
              })),
              (l = lt(g ? m[i] : 0, i, h)),
              i in m ||
      ...
      propHooks: {
        tabIndex: {
          get: function (e) {
            ...
            return t
              ? parseInt(t, 10)
              : ht.test(e.nodeName) || (ft.test(e.nodeName) && e.href)
              ? 0
              : -1;
          },
        },
  ...
  w.extend(w.event, {
    trigger: function (t, n, i, o) {
      ...
      if (
        ...
        if (!o && !h.noBubble && !g(i)) {
          for (
            l = h.delegateType || v, vt.test(l + v) || (s = s.parentNode);
            s;
            s = s.parentNode
          )
            y.push(s), (a = s);
        ...
        return (
          ...
          o ||
            ...
            (h._default && !1 !== h._default.apply(y.pop(), n)) ||
            !V(i) ||
            (c &&
              d(i[v]) &&
              !g(i) &&
  ...
  function Ct(e, t, n, i) {
    ...
    else for (o in t) Ct(e + "[" + o + "]", t[o], n, i);
  }
    ...
    w.extend({
      ...
      ajax: function (t, n) {
        ...
        f.hasContent
          ...
          : ((h = f.url.slice(o.length)),
            f.data &&
              ...
              ((o += (_t.test(o) ? "&" : "?") + f.data), delete f.data),
            !1 === f.cache &&
              ((o = o.replace(Lt, "$1")),
        ...
        if (
          ...
          if (((E.readyState = 1), u && g.trigger("ajaxSend", [E, f]), c))
            return E;
          f.async &&
            0 < f.timeout &&
            ...
            p
              ? (f.ifModified &&
                ...
                204 === t || "HEAD" === f.type
                  ...
                  : 304 === t
                  ? (k = "notmodified")
                  : ((k = x.state), (h = x.data), (p = !(m = x.error))))
  ...
  w.ajaxSetup({
    ...
    w.each(["top", "left"], function (e, t) {
      w.cssHooks[t] = We(f.pixelPosition, function (e, n) {
        if (n)
          return (n = qe(e, t)), Pe.test(n) ? w(e).position()[t] + "px" : n;
      });
    }),
  ...
  (function (e, t) {
          ...
          (("body" !== a(o) || p(u)) &&
            (f =
              o !== n(o) && r(o)
                ...
                : i(o)),
          r(o)
            ? (((d = t(o)).x += o.clientLeft), (d.y += o.clientTop))
            : u && (d.x = c(u))),
        {
    ...
    function f(e) {
      ...
      return (
        ...
        { x: e.offsetLeft, y: e.offsetTop, width: i, height: o }
      );
    }
    function d(e) {
      return "html" === a(e)
    ...
    function m(e, t) {
      ...
      var o = g(e);
      return (
        (e = o === (null == (i = e.ownerDocument) ? void 0 : i.body)),
        (i = n(o)),
      ...
      if ("viewport" === o) {
        ...
        o &&
          ...
          /^((?!chrome|android).)*safari/i.test(navigator.userAgent) ||
            ((p = o.offsetLeft), (h = o.offsetTop))),
          (e = k((e = { width: a, height: s, x: p + c(e), y: h })));
        ...
        (t =
          "clippingParents" === t
            ? (function (e) {
                var t = m(d(e)),
                  n =
                    0 <= ["absolute", "fixed"].indexOf(u(e).position) && r(e)
                      ? v(e)
                      : e;
                return o(n)
                  ? t.filter(function (e) {
    ...
    function L(e, n) {
      ...
      (c = e.rects.popper),
        (s = T(
          o((u = e.elements[u ? ("popper" === r ? "reference" : "popper") : r]))
            ? u
    ...
    function N(e) {
      ...
      if (!0 === (e = e.roundOffsets)) {
        ...
        e = { x: U(U(s.x * h) / h) || 0, y: U(U(e * h) / h) || 0 };
      ...
      if (p) {
        ...
        b === n(i) &&
          ...
          "top" === r &&
            ((m = "bottom"), (h -= b[x] - o.height), (h *= c ? 1 : -1)),
          "left" === r &&
            ((g = "right"), (e -= b[w] - o.width), (e *= c ? 1 : -1));
      }
      return (
        ...
        c
          ? Object.assign(
              ...
              (d[g] = f ? "0" : ""),
              (d.transform =
                2 > (y.devicePixelRatio || 1)
                  ? "translate(" + e + "px, " + h + "px)"
                  : "translate3d(" + e + "px, " + h + "px, 0)"),
              d)
            )
          : Object.assign(
              {},
        ...
        fn: function (e) {
          ...
          if (((a = { x: 0, y: 0 }), s)) {
            if (o || r) {
              ...
              (c = "start" === c ? -d[b] : -h[b]),
                (d = t.elements.arrow),
                (d = i && d ? f(d) : { width: 0, height: 0 });
              var C = t.modifiersData["arrow#persistent"]
              ...
              (m = C[m]),
                ...
                (u =
                  ...
                  T -
                  g -
                  (u ? ("y" === p ? u.clientTop || 0 : u.clientLeft || 0) : 0)),
                (h = s[p] + h - g),
                o &&
                  ((o = i ? B(_, u) : _),
                  (k = i ? F(k, h) : k),
        ...
        fn: function (e) {
          ...
          if (
            ...
            o = A(
              "number" !=
                typeof (o =
                  "function" == typeof (o = o.padding)
                    ? o(Object.assign({}, n.rects, { placement: n.placement }))
                    : o)
                ? o
                : O(o, R)
            );
  ...
  (function (e, t) {
    ...
    const e = (e) => {
      ...
      s = (e, t, n) => {
        Object.keys(n).forEach((i) => {
          ...
          if (!new RegExp(r).test(a))
            throw new TypeError(
              `${e.toUpperCase()}: Option "${i}" provided type "${a}" but expected type "${r}".`
            );
        });
      },
      a = (e) =>
      ...
      y = (e, t, n = !0) => {
        ...
        const s = ({ target: n }) => {
          n === t &&
            ((r = !0), t.removeEventListener("transitionend", s), m(e));
        };
          ...
          return (
            ...
            s
              ? ((p = document.createEvent("HTMLEvents")),
                p.initEvent(o, l, !0))
              : (p = new CustomEvent(t, { bubbles: l, cancelable: !0 })),
            void 0 !== n &&
    ...
    class te extends H {
      ...
      show() {
        ...
        if (this._config.parent) {
          ...
          t = U.find(".show, .collapsing", this._config.parent).filter(
            (t) => !e.includes(t)
          );
        }
        ...
        if (t.length) {
          ...
          if (((e = i ? te.getInstance(i) : null), e && e._isTransitioning))
            return;
        }
    ...
    function Ee(e) {
      return "html" === ue(e)
        ? e
        : e.assignedSlot || e.parentNode || (de(e) ? e.host : null) || ke(e);
    }
    function Te(e) {
    ...
    function Ie(e) {
        ...
        u =
          !0 === c
            ? (function (e) {
                ...
                return { x: Le(Le(t * i) / i) || 0, y: Le(Le(n * i) / i) || 0 };
              })(r)
            : "function" == typeof c
            ? c(r)
            : r,
      ...
      if (l) {
        var x = Se(n),
          ...
          _ = "clientWidth";
        x === pe(n) &&
          "static" !== we((x = ke(n))).position &&
          ((w = "scrollHeight"), (_ = "scrollWidth")),
          (x = x),
          o === ne && ((v = ie), (d -= x[w] - i.height), (d *= a ? 1 : -1)),
          o === re && ((y = oe), (h -= x[_] - i.width), (h *= a ? 1 : -1));
      }
      var k,
        E = Object.assign({ position: s }, l && Pe);
      return a
        ? Object.assign(
            {},
            E,
            ...
            (function (e) {
              ...
              return (
                "rtl" === we(o || n).direction &&
                  (a += Ae(n.clientWidth, o ? o.clientWidth : 0) - r),
              ...
              return (
                (e[n] = (function (e, t, n) {
                  ...
                  return (
                    (s = s || 0),
                    (a = (a || 0) * o),
                    [re, oe].indexOf(i) >= 0 ? { x: a, y: s } : { x: s, y: a }
                  );
                })(n, t.rects, r)),
                e
              );
                ...
                if (lt(t, n)) {
                  ...
                  for (var i = 0; i < a.orderedModifiers.length; i++)
                    if (!0 !== a.reset) {
                      ...
                      "function" == typeof r &&
                        (a =
                          r({ state: a, options: l, name: p, instance: u }) ||
                          a);
                    } else (a.reset = !1), (i = -1);
                }
              }
    ...
    var ut = ct(),
      pt = ct({ defaultModifiers: [qe, ot, He, ge] }),
      ht = ct({ defaultModifiers: [qe, ot, He, ge, it, Ze, rt, De, nt] }),
      ft = Object.freeze({
        __proto__: null,
        popperGenerator: ct,
        detectOverflow: Je,
      ...
      static dataApiKeydownHandler(e) {
        ...
        if ("Escape" !== e.key)
          return "ArrowUp" === e.key || "ArrowDown" === e.key
            ...
            : void ((t && "Space" !== e.key) || kt.clearMenus());
        i.hide();
      }
    }
    D.on(
    ...
    class Ct {
      ...
      _getConfig(e) {
        return (
          ((e = { ...Tt, ...("object" == typeof e ? e : {}) }).rootElement = r(
            e.rootElement
          )),
          s("backdrop", e, St),
          e
    ...
    const At = { trapElement: null, autofocus: !0 },
      Ot = { trapElement: "element", autofocus: "boolean" };
    class Lt {
      constructor(e) {
        (this._config = this._getConfig(e)),
          (this._isActive = !1),
      ...
      _getConfig(e) {
        return (
          (e = { ...At, ...("object" == typeof e ? e : {}) }),
          s("focustrap", e, Ot),
          e
        );
      }
    }
    const Mt = { backdrop: !0, keyboard: !0, focus: !0 },
      jt = {
    ...
    const Dt = { backdrop: !0, keyboard: !0, scroll: !1 },
      Pt = { backdrop: "boolean", keyboard: "boolean", scroll: "boolean" };
    class It extends H {
      constructor(e, t) {
        super(e),
          (this._config = this._getConfig(t)),
    ...
    D.on(
      ...
      D.on(window, "load.bs.offcanvas.data-api", () =>
        U.find(".offcanvas.show").forEach((e) =>
          It.getOrCreateInstance(e).show()
        )
      ),
      R(It),
      g(It);
    const Ht = new Set([
      ...
      Wt = (e, t) => {
        ...
        if (t.includes(n))
          return (
            !Ht.has(n) || Boolean(Rt.test(e.nodeValue) || qt.test(e.nodeValue))
          );
    ...
    class Vt extends H {
      ...
      show() {
        ...
        I.set(i, this.constructor.DATA_KEY, this),
          ...
          this._popper
            ? this._popper.update()
            : (this._popper = ht(this._element, i, this._getPopperConfig(s))),
      ...
      _getConfig(e) {
        ...
        return (
          ...
          e.sanitize &&
            (e.template = zt(e.template, e.allowList, e.sanitizeFn)),
          e
        );
      }
      _getDelegateConfig() {
    ...
    const $t = {
      ...
      Kt = { ...Vt.DefaultType, content: "(string|element|function)" },
      Qt = {
      ...
      _activate(e) {
        ...
        n.classList.add("active"),
          n.classList.contains("dropdown-item")
            ...
            : U.parents(n, ".nav, .list-group").forEach((e) => {
                U.prev(e, ".nav-link, .list-group-item").forEach((e) =>
                  e.classList.add("active")
                ),
                  U.prev(e, ".nav-item").forEach((e) => {
                    U.children(e, ".nav-link").forEach((e) =>
                      e.classList.add("active")
                    );
                  });
              }),
    ...
    class nn extends H {
      ...
      _transitionComplete(e, t, n) {
        ...
        if (
          ...
          t &&
            U.find(".dropdown-toggle", t).forEach((e) =>
              e.classList.add("active")
            ),
    ...
    const on = { animation: "boolean", autohide: "boolean", delay: "number" },
      rn = { animation: !0, autohide: !0, delay: 5e3 };
    class sn extends H {
      constructor(e, t) {
        super(e),
          (this._config = this._getConfig(t)),
  ...
  (function (e, t) {
    ...
    function h(e, t, n, i, o) {
      var r;
      if ((void 0 === i && (i = !0), void 0 === o && (o = !1), "top" === t))
        r = [
          "contentHeight",
          "containerHeight",
          "scrollTop",
      ...
      !(function (e, t, n, i, o) {
        ...
        (e.reach[l] = null),
          ...
          t &&
            (f.dispatchEvent(p("ps-scroll-" + l)),
            0 > t
              ? f.dispatchEvent(p("ps-scroll-" + c))
              : 0 < t && f.dispatchEvent(p("ps-scroll-" + h)),
            i && u(e, l)),
          e.reach[l] &&
            (t || o) &&
            f.dispatchEvent(p("ps-" + l + "-reach-" + e.reach[l]));
      })(e, n, r, i, o);
    }
    function f(e) {
      ...
      (e.containerWidth = n(r.width)),
        ...
        e.containerWidth + e.settings.scrollXMarginOffset < e.contentWidth
          ? ((e.scrollbarXActive = !0),
            ...
            (e.scrollbarXWidth = m(
              e,
              f((e.railXWidth * e.containerWidth) / e.contentWidth)
            )),
            (e.scrollbarXLeft = f(
        ...
        y(i, e),
        e.scrollbarXActive
          ? i.classList.add(x.state.active("x"))
          : (i.classList.remove(x.state.active("x")),
            (e.scrollbarXWidth = 0),
            (e.scrollbarXLeft = 0),
            (i.scrollLeft = !0 === e.isRtl ? e.contentWidth : 0)),
        e.scrollbarYActive
          ? i.classList.add(x.state.active("y"))
          : (i.classList.remove(x.state.active("y")),
    ...
    (_.prototype.bind = function (e, t) {
      ...
      (_.prototype.unbind = function (e, t) {
        ...
        this.handlers[e] = this.handlers[e].filter(function (i) {
          return (
            !(!t || i === t) || (n.element.removeEventListener(e, i, !1), !1)
          );
        });
      }),
      ...
      S = {
              ...
              (e.settings.suppressScrollX && 0 !== a) ||
                ...
                (function (i, o) {
                  ...
                  if (0 === o) {
                    ...
                    if (
                      (0 === s && 0 > i) ||
                      (s >= e.contentWidth - e.containerWidth && 0 < i)
                    )
                      return !e.settings.wheelPropagation;
                  }
                  return !0;
        ...
        wheel: function (i) {
          function o(e, t, i) {
            ...
            for (var o = e; o && o !== s; ) {
              ...
              if (i && r.overflowY.match(/(scroll|auto)/)) {
                ...
                if (
                  0 < a &&
                  ((0 < o.scrollTop && 0 > i) || (o.scrollTop < a && 0 < i))
                )
                  return !0;
              }
              if (t && r.overflowX.match(/(scroll|auto)/)) {
                ...
                if (
                  0 < l &&
                  ((0 < o.scrollLeft && 0 > t) || (o.scrollLeft < l && 0 < t))
                )
                  return !0;
              }
              o = o.parentNode;
            ...
            if (!o(n.target, a, l)) {
              ...
              i.settings.useBothWheelAxes
                ? i.scrollbarYActive && !i.scrollbarXActive
                  ? (l
                      ? (s.scrollTop -= l * i.settings.wheelSpeed)
                  ...
                  : i.scrollbarXActive &&
                    ...
                    (a
                      ...
                      : (s.scrollLeft -= l * i.settings.wheelSpeed),
                    (c = !0))
                : ((s.scrollTop -= l * i.settings.wheelSpeed),
                  (s.scrollLeft += a * i.settings.wheelSpeed)),
                g(i),
          ...
          void 0 === window.onwheel
            ? void 0 !== window.onmousewheel && i.event.bind(s, "mousewheel", r)
            : i.event.bind(s, "wheel", r);
        },
        touch: function (i) {
          function o(n, o) {
            var r = t(h.scrollTop),
            ...
            if (l > a) {
              ...
              a > l &&
              ((0 > n && s === i.contentWidth - i.containerWidth) ||
                (0 < n && 0 === s))
            )
              return !0;
            return !0;
          ...
          function c(e, t, i) {
            ...
            for (var o = e; o && o !== h; ) {
              ...
              if (i && r.overflowY.match(/(scroll|auto)/)) {
                ...
                if (
                  0 < s &&
                  ((0 < o.scrollTop && 0 > i) || (o.scrollTop < s && 0 < i))
                )
                  return !0;
              }
              if (t && r.overflowX.match(/(scroll|auto)/)) {
                ...
                if (
                  0 < a &&
                  ((0 < o.scrollLeft && 0 > t) || (o.scrollLeft < a && 0 < t))
                )
                  return !0;
              }
              o = o.parentNode;
          ...
          if (T.supportsTouch || T.supportsIePointer) {
            var h = i.element,
              ...
              y = null;
            T.supportsTouch
              ? (i.event.bind(h, "touchstart", l),
                i.event.bind(h, "touchmove", u),
                i.event.bind(h, "touchend", p))
              : T.supportsIePointer &&
                (window.PointerEvent
                  ? (i.event.bind(h, "pointerdown", l),
                    i.event.bind(h, "pointermove", u),
                    i.event.bind(h, "pointerup", p))
                  : window.MSPointerEvent &&
                    (i.event.bind(h, "MSPointerDown", l),
      ...
      C = function (e, r) {
        ...
        (this.scrollbarXBottom = parseInt(u.bottom, 10)),
          isNaN(this.scrollbarXBottom)
            ? ((this.isScrollbarXUsingBottom = !1),
              (this.scrollbarXTop = f(u.top)))
            : (this.isScrollbarXUsingBottom = !0),
          (this.railBorderXWidth =
            f(u.borderLeftWidth) + f(u.borderRightWidth)),
        ...
        (this.scrollbarYRight = parseInt(p.right, 10)),
          ...
          (this.railBorderYWidth =
            f(p.borderTopWidth) + f(p.borderBottomWidth)),
      ...
      (C.prototype.update = function () {
        this.isAlive &&
          ...
          (this.railXMarginWidth =
            f(n(this.scrollbarXRail).marginLeft) +
            f(n(this.scrollbarXRail).marginRight)),
          (this.railYMarginHeight =
            f(n(this.scrollbarYRail).marginTop) +
            f(n(this.scrollbarYRail).marginBottom)),
  ...
  (function (e, t, n, i) {
    ...
    function x(e, t) {
      for (
        var n, o, r = t[0].toUpperCase() + t.slice(1), s = 0;
        s < oe.length;
    ...
    function Z(e, t) {
      return (
        ((t = t || {}).recognizers = p(t.recognizers, Z.defaults.preset)),
        new ee(e, t)
      );
    }
    function ee(e, t) {
      (this.options = ie({}, Z.defaults, t || {})),
        ...
        (this.input = (function (e) {
          return new (e.options.inputClass || (de ? j : ge ? P : fe ? H : M))(
            e,
            k
          );
        })(this)),
    ...
    var ue = a(
      ...
      ge =
        fe && /mobile|tablet|ip(ad|hone|od)|android/i.test(navigator.userAgent),
      me = "touch",
      ye = "mouse",
      ve = 25,
      be = 1,
    ...
    var We = { touchstart: be, touchmove: xe, touchend: we, touchcancel: _e },
      ze = "touchstart",
    ...
    var Be = { touchstart: be, touchmove: xe, touchend: we, touchcancel: _e },
      ...
      set: function (e) {
        e == Ke && (e = this.compute()),
          $e &&
            ...
            tt[e] &&
            (this.manager.element.style[Ve] = e),
    ...
    (F.prototype = {
      ...
      recognizeWith: function (e) {
        ...
        return (
          t[(e = X(e, this)).id] || ((t[e.id] = e), e.recognizeWith(this)), this
        );
      },
      dropRecognizeWith: function (e) {
        return (
          r(e, "dropRecognizeWith", this) ||
            ((e = X(e, this)), delete this.simultaneous[e.id]),
          this
        );
      },
      requireFailure: function (e) {
        ...
        return (
          -1 === y(t, (e = X(e, this))) && (t.push(e), e.requireFailure(this)),
          this
        );
      },
      ...
      recognize: function (e) {
        ...
        return u(this.options.enable, [this, t])
          ? (this.state & (st | at | lt) && (this.state = nt),
            (this.state = this.process(t)),
            void (this.state & (it | ot | rt | at) && this.tryEmit(t)))
      ...
      l(V, Y, {
        ...
        attrTest: function (e) {
          return (
            Y.prototype.attrTest.call(this, e) &&
            (this.state & it || (!(this.state & it) && this.directionTest(e)))
          );
        },
        emit: function (e) {
      ...
      l($, Y, {
        ...
        attrTest: function (e) {
          return (
            ...
            (Math.abs(e.scale - 1) > this.options.threshold || this.state & it)
          );
        },
        emit: function (e) {
          if (1 !== e.scale) {
      ...
      l(K, F, {
        ...
        process: function (e) {
          ...
          if (((this._input = e), !i || !n || (e.eventType & (we | _e) && !r)))
            this.reset();
      ...
      l(Q, Y, {
        ...
        attrTest: function (e) {
          return (
            this._super.attrTest.call(this, e) &&
            (Math.abs(e.rotation) > this.options.threshold || this.state & it)
          );
        },
      }),
      l(G, Y, {
      ...
      l(J, F, {
        ...
        process: function (e) {
          var t = this.options,
            ...
            i = e.distance < t.threshold,
            r = e.deltaTime < t.time;
          if ((this.reset(), e.eventType & be && 0 === this.count))
  ...
  (Unison = (function () {
    ...
    var e,
      ...
      l = {
        all: function () {
          for (
            var e = {},
              t = s.parseMQ(n.querySelector("title")).split(","),
              i = 0;
            i < t.length;
            i++
          ) {
    ...
    return (
      ...
      {
        fetch: { all: l.all, now: l.now },
        on: a.on,
        emit: a.emit,
        util: { debounce: s.debounce, isObject: s.isObject },
      }
    );
  })()),
  (function () {
    ...
    function e(e) {
      function t(t, i) {
        ...
        if (
          !(i = e.extend({}, e.blockUI.defaults, i || {})).ignoreIfBlocked ||
          ...
          (b = e(
            ...
            m &&
              (i.theme
                ? (w.css(d), w.addClass("ui-widget-content"))
                : w.css(r)),
          ...
          var S =
            p &&
            (!e.support.boxModel || e("object,embed", g ? null : t).length > 0);
          if (u || S) {
            if (
              (g &&
                i.allowBodyStretch &&
          ...
          if (
            (m &&
              (i.theme ? w.find(".ui-widget-content").append(m) : w.append(m),
          ...
          if (
            ...
            g
              ? ((h = w[0]),
                ...
                i.focusInput && setTimeout(s, 20))
              : (function (e, t, n) {
                  var i = e.parentNode,
                    o = e.style,
                    r =
                      (i.offsetWidth - e.offsetWidth) / 2 -
                      a(i, "borderLeftWidth"),
                    s =
                      (i.offsetHeight - e.offsetHeight) / 2 -
                      a(i, "borderTopWidth");
                  t && (o.left = r > 0 ? r + "px" : "0"),
                    n && (o.top = s > 0 ? s + "px" : "0");
      ...
      function n(t, n) {
        ...
        u && (clearTimeout(u), l.removeData("blockUI.timeout")),
          ...
          (s = a
            ...
            : l.find(">.blockUI")),
          n.cursorReset &&
            (s.length > 1 && (s[1].style.cursor = n.cursorReset),
      ...
      function o(t, n, i) {
        var o = n == window,
          s = e(n);
        if (
          (t || ((!o || h) && (o || s.data("blockUI.isBlocked")))) &&
      ...
      function r(t) {
        ...
        var r = t.data,
          a = e(t.target);
        return (
          a.hasClass("blockOverlay") && r.onOverlayClick && r.onOverlayClick(t),
          a.parents("div." + r.blockMsgClass).length > 0 ||
  ...
  function () {
    ...
    for (
      v = {
        ...
        h = function (e, t, n) {
          ...
          var i;
          "function" != typeof e["on" + t] ||
          "object" != typeof e["on" + t].eventListeners
            ? ((i = new o()),
        ...
        b = function () {
          for (
            var e,
              ...
              n,
              i = arguments[0],
              o = 2 <= arguments.length ? V.call(arguments, 1) : [],
              r = 0,
              s = o.length;
            r < s;
            r++
          ...
          if (null != (null != (i = this.bindings) ? i[e] : void 0)) {
            ...
            for (n = 0, o = []; n < this.bindings[e].length; )
              this.bindings[e][n].handler === t
                ? o.push(this.bindings[e].splice(n, 1))
                : o.push(n++);
            return o;
          }
        },
        G.prototype.trigger = function () {
          ...
          if (null != (i = this.bindings) && i[s]) {
            for (n = 0, r = []; n < this.bindings[s].length; )
        ...
        W = 0,
        F = (U = ["ajax", "document", "eventLag", "elements"]).length;
      W < F;
      W++
    )
      !0 === C[(D = U[W])] && (C[D] = v[D]);
      ...
      te.__super__.constructor.apply(this, arguments),
        (e = function (e) {
          ...
          return (e.open = function (i, o, r) {
            return (
              N(i) && t.trigger("request", { type: i, url: o, request: e }),
              n.apply(e, arguments)
            );
          });
        }),
    ...
    function re() {
      var e,
        ...
        n = this;
      (this.progress =
        null != (t = this.states[document.readyState]) ? t : 100),
    ...
    K(J, (Y = Error)),
      ...
      (Z.prototype.finish = function () {
        ...
        return (
          (e.className = e.className.replace("pace-active", "pace-inactive")),
          (document.body.className = document.body.className.replace(
            "pace-running ",
            "pace-done "
          ))
      ...
      (Z.prototype.render = function () {
        ...
        for (
          e = this.getElement(),
            ...
            o = 0,
            r = (a = ["webkitTransform", "msTransform", "transform"]).length;
          o < r;
          o++
        )
          (t = a[o]), (e.children[0].style[t] = i);
        return (
      ...
      (ee.prototype.trigger = function (e, t) {
        ...
        if (null != this.bindings[e]) {
          for (s = [], i = 0, o = (r = this.bindings[e]).length; i < o; i++)
            (n = r[i]), s.push(n.call(this, t));
          return s;
        }
      }),
      ...
      (N = function (e) {
        ...
        if (!E.length && C.ajax) {
          ...
          if (((e = e.toUpperCase()), 0 <= Q.call(C.ajax.trackMethods, e)))
            return !0;
        }
        return !1;
      }),
      ...
      (_ = function () {
        ...
        if (!j(r))
          return s.running ||
            (!1 === C.restartOnRequestAfter && "force" !== N(i))
            ? void 0
            : ((n = arguments),
              ...
              setTimeout(function () {
                var e,
                  ...
                  c =
                    "socket" === i
                      ? o.readyState < 1
                      : 0 < (c = o.readyState) && c < 4;
                if (c) {
                  for (
                    s.restart(), l = [], e = 0, r = (a = s.sources).length;
                    e < r;
                    e++
                  ) {
      ...
      (ne.prototype.watch = function (e) {
        ...
        if (!j(e))
          return (
            (n = new ("socket" === t ? u : p)(n, this.complete)),
          ...
          for (
            h(e, "progress", function (e) {
              return e.lengthComputable
                ? (s.progress = (100 * e.loaded) / e.total)
        ...
        (this.progress = 0),
          ...
          (t = setInterval(function () {
            ...
            return (
              ...
              (e = d(o)),
              ++i >= C.eventLag.minSamples && e < C.eventLag.lagThreshold
                ? ((r.progress = 100), clearInterval(t))
      ...
      (se.prototype.tick = function (e, t) {
        return (
          100 <= (t = null == t ? O(this.source, "progress") : t) &&
            (this.done = !0),
          t === this.last
            ? (this.sinceLastUpdate += e)
            : (this.sinceLastUpdate &&
                (this.rate = (t - this.last) / this.sinceLastUpdate),
      ...
      (l = { ajax: t, elements: w, document: Y, eventLag: K }),
      (T = function () {
        var e, t, i, o, r, a, u, p;
        for (
          s.sources = P = [],
            t = 0,
            o = (a = ["ajax", "elements", "document", "eventLag"]).length;
          t < o;
          t++
        )
          !1 !== C[(e = a[t])] && P.push(new l[e](C[e]));
        for (
          i = 0, r = (p = null != (u = C.extraSources) ? u : []).length;
          i < r;
          i++
        )
          (D = p[i]), P.push(new D(C));
      ...
      (s.stop = function () {
        return (
          ...
          g.destroy(),
          (m = !0),
          null != f && ("function" == typeof y && y(f), (f = null)),
          T()
        );
      }),
      (s.restart = function () {
            ...
            for (
              ...
              for (
                D = P[b],
                  l = null != M[b] ? M[b] : (M[b] = []),
                  r = h = 0,
                  f = (o = null != (d = D.elements) ? d : [D]).length;
                h < f;
                r = ++h
              )
                (a = o[r]),
            ...
            return (
              ...
              g.done() || v || m
                ? (g.update(100),
                  ...
                  }, Math.max(C.ghostTime, Math.max(C.minTime - (S() - e), 0))))
                : n()
            );
          }))
        );
      ...
      (s.start = function (e) {
        ...
        return document.querySelector(".pace")
          ? (s.trigger("start"), s.go())
          : setTimeout(s.start, 50);
      }),
      "function" == typeof define && define.amd
        ? define(function () {
            return s;
  ...
  (function (e, t) {
    ...
    function s(e) {
      ...
      return (
        ...
        (t =
          null !== (i = n = r) && i === i.window
            ? n
            : 9 === n.nodeType && n.defaultView),
        {
          ...
          (c =
            ...
            (c =
              "touches" in e && e.touches.length
                ? ((r = e.touches[0].pageY - o.top),
                  e.touches[0].pageX - o.left)
                : ((r = e.pageY - o.top), e.pageX - o.left))
              ? c
              : 0),
            (r = 0 <= r ? r : 0);
      ...
      c = {
        input: function (e) {
          ...
          ("i" === r.tagName.toLowerCase() &&
            r.classList.contains("waves-effect")) ||
            (((t = document.createElement("i")).className =
              e.className + " waves-input-wrapper"),
    ...
    function u(e, t, n) {
      ...
      n &&
        ...
        (c = 350 - (Date.now() - Number(n.getAttribute("data-hold")))) < 0 &&
          (c = 0),
        ...
        p.registerEvent(e),
          "touchstart" === e.type && l.delay
            ? ((t = !1),
              ...
              (o = function (i) {
                n && (clearTimeout(n), (n = null), l.show(e, a)),
                  t || ((t = !0), l.hide(i, a)),
                  s();
              }),
              (r = function (e) {
        ...
        if (
          ...
          for (
            ...
            (i.x = h.left + p.x),
              ...
              0 <= t.wait &&
                null !== t.wait &&
                setTimeout(c({ type: "mouseup", button: 1 }, u), t.wait);
          }
      }),
      (e.calm = function (e) {
        for (
          var t = { type: "mouseup", button: 1 }, n = 0, i = (e = r(e)).length;
          n < i;
          n++
        )
          l.hide(t, e[n]);
            ...
            },
            {
              ...
              value: function (e, t) {
                ...
                if (n && e.indexOf(n) > -1) {
                  ...
                  var s = e.split(n);
                  (n !== i ||
                    (n === i && this.options.ns.indexOf(s[0]) > -1)) &&
                    (o = s.shift()),
                    (e = s.join(i));
                }
                return (
                ...
                if (
                  ...
                  if (!i.returnObjects && !this.options.returnObjects)
                    return (
                      ...
                      this.options.returnedObjectHandler
                        ? this.options.returnedObjectHandler(m, g, i)
                        : "key '"
                            .concat(l, " (")
                            .concat(
                              this.language,
                  ...
                  if (C || S || O) {
                    if (
                      ...
                      var L = this.resolve(l, n({}, i, { keySeparator: !1 }));
                      L &&
                        L.res &&
                        this.logger.warn(
            ...
            },
            {
              ...
              value: function (e, t, i, o, r) {
                ...
                if (this.i18nFormat && this.i18nFormat.parse)
                  ...
                  var a,
                    l =
                      (i.interpolation && i.interpolation.skipOnVariables) ||
                  ...
                  var u =
                    i.replace && "string" != typeof i.replace ? i.replace : i;
                  if (
                      ...
                      function () {
                        ...
                        return r && r[0] === n[0]
                          ? (s.logger.warn(
                            ...
                            null)
                          : s.translate.apply(s, n.concat([t]));
                      },
                      i
                    )),
                  ...
                  e.forEach(function (e) {
                    if (!s.isValidLookup(t)) {
                      ...
                      s.options.fallbackNS &&
                        (u = u.concat(s.options.fallbackNS));
                            ...
                            if (!s.isValidLookup(t)) {
                              ...
                              for (
                                s.i18nFormat && s.i18nFormat.addLookupKeys
                                  ? s.i18nFormat.addLookupKeys(f, c, n, e, a)
                                  : (p &&
                                      (r = s.pluralResolver.getSuffix(
                                        n,
                                        a.count
                                      )),
                                    p && h && f.push(u + r),
                ...
                return e
                  ? (e.forEach(function (e) {
                      if (!t) {
                        ...
                        (n.options.supportedLngs && !n.isSupportedCode(i)) ||
                          (t = i);
                      }
                    }),
                    !t &&
            ...
            },
            {
              ...
              value: function (e, t, n, i) {
                ...
                var p =
                  ...
                  h =
                    (i && i.interpolation && i.interpolation.skipOnVariables) ||
                    this.options.interpolation.skipOnVariables;
                return (
                  [
                    {
              ...
              value: function (e, t) {
                ...
                for (
                  ...
                  var c = [],
                    u = !1;
                  if (
                    i[0].includes(this.formatSeparator) &&
                    !/{.*}/.test(i[1])
                  ) {
        ...
        r(o, [
          ...
          },
          {
            ...
            value: function (t, i) {
                  ...
                  if ("object" !== e(r)) {
                    for (
                      var a = arguments.length,
                        l = new Array(a > 2 ? a - 2 : 0),
                        c = 2;
                      c < a;
                      c++
                    )
                      l[c - 2] = arguments[c];
                    s = o.options.overloadTranslationOptionHandler(
                      [i, r].concat(l)
                    );
                  } else s = n({}, r);
                  return (
              ...
              return (
                "string" == typeof t ? (r.lng = t) : (r.lngs = t), (r.ns = i), r
              );
            },
          },
          {
  ...
  (function (e, t) {
    "object" == typeof exports && "undefined" != typeof module
      ...
      : "function" == typeof define && define.amd
      ? define(t)
      : ((e = e || self).i18nextBrowserLanguageDetector = t());
  })(this, function () {
    "use strict";
    function e(e, t) {
      for (var n = 0; n < t.length; n++) {
  ...
  (function (e, t) {
    ...
    return {
      init: function (n, i) {
        function o(t, i, o) {
          function r(t, n) {
            return a.parseDefaultValueFromContent
              ? e({}, t, { defaultValue: n })
              : t;
          }
          if (0 !== i.length) {
      ...
      function (e, t, n) {
        ...
        e.exports = function (e) {
          var t,
            ...
            v = c(h);
          if (
            (m && (g = i(g, d > 2 ? arguments[2] : void 0, 2)),
            null == v || (f == Array && s(v)))
          )
            for (n = new f((t = a(h.length))); t > y; y++)
              l(n, y, m ? g(h[y], y) : h[y]);
          else
            for (p = v.call(h), n = new f(); !(u = p.next()).done; y++)
          ...
          if (
            (O &&
              ...
              d !== Object.prototype &&
                ...
                (p ||
                  r(x) === d ||
                  (s ? s(x, d) : "function" != typeof x[m] && l(x, m, y)),
                a(x, E, !0, !0),
                p && (h[E] = y))),
            "values" == f &&
              C &&
      ...
      return this.each(function () {
            ...
            ? (0 < r.decimals && "." === e) ||
              ...
              (n = (function (e) {
                switch (r.forcestepdivisibility) {
                  case "round":
                    return (Math.round(e / r.step) * r.step).toFixed(
                      r.decimals
                    );
                  case "floor":
                    return (Math.floor(e / r.step) * r.step).toFixed(
                      r.decimals
                    );
                  case "ceil":
              ...
              Number(e).toString() !== n.toString() &&
                (g.val(n), g.trigger("change")))
            : "" !== r.replacementval &&
              (g.val(r.replacementval), g.trigger("change"));
        }
        function w() {
          if (r.booster) {
            ...
            return (
              r.maxboostedstep &&
                e > r.maxboostedstep &&
                ((e = r.maxboostedstep), (u = Math.round(u / e) * e)),
              Math.max(r.step, e)
            );
          }
          return r.step;
        ...
        function k() {
          ...
          isNaN(u) ? (u = _()) : ((e = w()), (u += e)),
            null !== r.max &&
              u > r.max &&
              ((u = r.max), g.trigger("touchspin.on.max"), C()),
            c.input.val(
              r.callback_after_calculation(Number(u).toFixed(r.decimals))
            ),
        ...
        function E() {
          ...
          isNaN(u) ? (u = _()) : ((e = w()), (u -= e)),
            null !== r.min &&
              u < r.min &&
              ((u = r.min), g.trigger("touchspin.on.min"), C()),
            c.input.val(
              r.callback_after_calculation(Number(u).toFixed(r.decimals))
            ),
            t !== u && g.trigger("change");
                ...
                ? ("" !==
                  ...
                  (function () {
                    var t = g.val(),
                      n = g.parent();
                    "" !== t &&
                      (t = r.callback_after_calculation(
                        Number(t).toFixed(r.decimals)
                      )),
                  ...
                  (c = {
                    ...
                    input: e("input", l),
                    prefix: e(".bootstrap-touchspin-prefix", l).addClass(
                      r.prefix_extraclass
                    ),
                    postfix: e(".bootstrap-touchspin-postfix", l).addClass(
                  ...
                  g.on("keydown.touchspin", function (e) {
                    ...
                    38 === t
                      ? ("up" !== v && (k(), S()), e.preventDefault())
                      : 40 === t &&
                        ("down" !== v && (E(), T()), e.preventDefault());
                  }),
                  ...
                  c.up.on("mousedown.touchspin", function (e) {
                    c.up.off("touchstart.touchspin"),
                      g.is(":disabled") ||
                        (k(), S(), e.preventDefault(), e.stopPropagation());
                  }),
                    ...
                    !(function (t) {
                      (function (t) {
                        (r = e.extend({}, r, t)),
                          t.postfix &&
                            (0 ===
                              g.parent().find(".bootstrap-touchspin-postfix")
                                .length && a.insertAfter(g),
                            g
                              .parent()
                              .find(
                          ...
                          t.prefix &&
                            (0 ===
                              g.parent().find(".bootstrap-touchspin-prefix")
                                .length && s.insertBefore(g),
                            g
                              .parent()
                              .find(
